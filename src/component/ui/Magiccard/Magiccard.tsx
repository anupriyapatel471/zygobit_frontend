...
export function MagicCardDemo() {
  return (
    <div className={" grid grid-cols-1 sm:grid-cols-3  w-full flex-col gap-4  lg:flex-row"}>
      <MagicCard data-aos="fade-right" className="bg-primaryBg p-4 lg:py-9 lg:px-6 border border-[#FFFFFF26] rounded-lg">
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-between">
          <h3 className="w-full order-2 sm:order-none sm:w-[calc(100%-125px)] text-xl lg:text-2xl font-semibold tracking-tighter">
            Custom Solution Architects
          </h3>
          <button className="order-1 sm:order-none mb-3 w-[52px] text-white btn-primary bg-gradient-custom">
            <ArrowRight />
          </button>
        </div>
      ...
      <MagicCard data-aos="fade-left" className="bg-primaryBg p-4 lg:py-9 lg:px-6 border border-[#FFFFFF26] rounded-lg">
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-between">
          <h3 className="w-full order-2 sm:order-none sm:w-[calc(100%-125px)] text-xl lg:text-2xl font-semibold tracking-tighter">
