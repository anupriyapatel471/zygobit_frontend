...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-orange-300 to-orange-600 flex-shrink-0" />
...
const SkeletonFour = () => {
  ...
  return (
    <motion.div
      ...
      animate="animate"
      whileHover="hover"
      className="grid grid-cols-1 gap-4 sm:gap-0 sm:flex flex-1 w-full h-full min-h-[6rem] bg-dot-white/[0.2]  flex-row sm:space-x-2"
    >
      <motion.div
        variants={first}
        className="no-rotate h-full w-auto sm:w-1/3 rounded-2xl  p-4 bg-black border-white/[0.1] border  flex flex-col items-center justify-center"
      >
        <Image
        ...
        <p className="border  bg-red-100 bg-red-900/20 text-red-600 text-xs rounded-full px-2 py-0.5 mt-4">
          Delusional
        </p>
      </motion.div>
      <motion.div className="h-full relative z-20 w-auto sm:w-1/3 rounded-2xl  p-4 bg-black border-white/[0.1] border  flex flex-col items-center justify-center">
        <Image
          src="https://pbs.twimg.com/profile_images/1417752099488636931/cs2R59eW_400x400.jpg"
          alt="avatar"
          height="100"
        ...
        <p className="border  bg-green-100 bg-green-900/20 text-green-600 text-xs rounded-full px-2 py-0.5 mt-4">
          Sensible
        </p>
      </motion.div>
      <motion.div
