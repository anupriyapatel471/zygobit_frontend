...
export function MobileAppCards() {
  return (
    <Card>
...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      ...
      <div className="h-40 w-px absolute top-[3rem] sm:top-20 m-auto z-40 bg-gradient-to-b from-transparent via-orange-500 to-transparent animate-move">
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "w-full mx-auto p-8 h-[20rem] sm:h-[30rem] lg:h-[38rem] flex items-center justify-center rounded-xl border border-[rgba(255,255,255,0.10)] bg-[rgba(40,40,40,0.70)]  shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] group",
        className
      )}
    >
      {children}
