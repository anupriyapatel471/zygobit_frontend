  ...
  return (
    <Accordion type="single" collapsible className="w-full bg-white/5">
      <AccordionItem value="item-1">
        <AccordionTrigger>
          Why choose Zygobit mobile app development services?
        </AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger>
          What is the cost of mobile app development in 2024?
        </AccordionTrigger>
        <AccordionContent>
      ...
      <AccordionItem value="item-5">
        <AccordionTrigger>
          What is the difference between cross-platform app development and
