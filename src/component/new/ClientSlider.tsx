    ...
    <Carousel className="w-full max-w-full">
      <CarouselContent className="ml-0 lg:ml-0 gap-9">
        {testimonials.map((data, index) => (
          ...
          >
            <div
              className="border-[6px] border-[#FFFFFF38] relative bg-[#FEF8FF36] backdrop-blur-2xl h-[555px] rounded-3xl p-4 overflow-hidden"
            ...
            >
              ...
              <CardContent className="flex items-center justify-center p-0">
                <div className="w-full">
                  {!data.videosrc && (
                    <p className="text-base text-white">{data.quote}</p>
                  )}
