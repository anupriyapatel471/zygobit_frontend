      ...
      >
        <div className="container remove-bg">
          <div className="w-full text-center mb-5 sm:mb-36 lg:mb-10">
            ...
            <p className="sm:font-medium text-sm sm:text-lg lg:text-xl mx-auto mt-5 text-black">
          ...
          <div className="w-full">
            ...
            >
              <TabsList className="grid grid-cols-1 w-[160px] gap-5 text-black">
              ...
              <TabsContent value="Frontend">
                <div className="w-full bg-[#FF71461A] rounded-2xl h-[455px] p-10">
                  <div className="w-full flex gap-10 items-center">
                    <div className="w-[315px] h-[390px] relative">
                      <Image
                        fill
                    ...
                    <div className="w-[calc(100%-315px)] flex flex-col gap-5 text-black">
