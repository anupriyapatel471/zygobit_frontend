          ...
          <div className="w-full flex justify-between ">
            <div className="w-full lg:w-[520px] flex flex-col gap-5 sm:gap-10 py-6">
              ...
              <div className="w-full flex items-center gap-7">
                ...
                <h2
                  className="font-bold text-3xl sm:text-[35px] lg:text-[45px]"
                  style={{ color: projectData?.themeColor?.bgGradientTwo }}
                >
              ...
              <div className="w-full lg:max-w-sm grid grid-cols-2 gap-5">
                <div
                  ...
                  style={{
                    borderColor: projectData?.themeColor?.bgGradientTwo,
                  }}
                >
                  <div>
                    <svg
                    ...
                    >
                      <path
                        ...
                        fill={projectData?.themeColor?.bgGradientTwo}
                      />
                    </svg>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <path
                        ...
                        stroke={projectData?.themeColor?.bgGradientTwo}
                        strokeWidth="2.8"
                        strokeLinecap="round"
