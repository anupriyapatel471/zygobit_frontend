...
const ClientCaseStudy = ({ projectId }: { projectId: string }) => {
      ...
      <>
        <section className="w-full relative">
          ...
          <div className="container remove-bg">
            ...
            <div className="w-full hidden sm:inline absolute max-w-[1248px] mx-auto -bottom-[170px] left-1/2 -translate-x-1/2 rounded-lg">
              <div className="w-full border border-[#09090B33] overflow-hidden rounded-lg bg-[#fafafa12] px-10  ">
                  ...
                  <div className=" grid grid-cols-1 sm:grid-cols-3  w-full flex-col gap-4  lg:flex-row">
                    ...
                    >
                      <div className="w-full block pb-4 border-b-2 border-[#EA580C]">
                        <h3 className="w-full order-2 sm:order-none sm:min-h-[76px] sm:w-[calc(100%-65px)] 2xl:w-[calc(100%-125px)] text-xl lg:text-xl 2xl:text-2xl font-semibold tracking-tighter">
                          Client Location
                        </h3>
                      </div>
        ...
        <section className="w-full overflow-hidden">
          <div className="container remove-bg">
            <div className="w-full flex flex-wrap lg:flex-nowrap items-center gap-8 sm:gap-16">
              ...
              <div className="w-full lg:w-1/2">
                <div className="w-full sm:w-[496px] ml-auto  relative  bg-[#EA580C] h-[350px] sm:h-[440px] rounded-2xl">
