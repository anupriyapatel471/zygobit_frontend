...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute  left-0 lg:left-0 top-3 hidden lg:inline">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
          ...
          className="ml-[27px] h-5 w-5 rounded-full border-2 border-[#4B5563] shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
